...
public class Punonjes {
	...
	public static void afishoPunonjes(Punonjes punonjes) {
		...
		if (punonjes != null)
			System.out.printf("%-9s%-13s%11.2f\n", punonjes.getEmri(), punonjes.getMbiermi(),
	...
	public int getMosha() {
		// to do
		// Te perdore klasa java.util.date per te marr daten korente
		// dhe per te bere extract vitin koren
		// mosha mosha llogaritet si diference midis vitit kohrent edhe vitit te lindje
		//
